<?php
use Memcached;
class typecho_memcached implements BhCache
{
	...
	public function init($option)
	{
		try {
			...
			$this->mcd->addServer($this->host, $this->port);
			$this->mc = new \MatthiasMullie\Scrapbook\Adapters\Memcached($this->mcd);
            $this->mc = new \MatthiasMullie\Scrapbook\Scale\StampedeProtector($this->mc);
		} catch (Exception $e){
			$this->mc = null;
