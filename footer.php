...
<script src="<?php $this->options->themeUrl('assets/js/bearhoney_single.js?v='); ?><?php echo themeVersion();?>"></script>
...
<script src="<?php $this->options->themeUrl('assets/plugins/menu/menu.min.js'); ?>"></script>
<script>
