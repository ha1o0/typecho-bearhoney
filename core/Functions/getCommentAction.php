...
$options = Helper::options();
    $temoptions = bhOptions::getInstance()::get_option( 'bearhoney' );
...
$str = mt_rand(100001,999999); 
     ...
     $securityToken = \BearHoneyCore\Plugin::authToken($str,'ENCODE',$key,0);
     \BearHoneyCore\Plugin::getSecurity('set','__typecho_security_token',$securityToken);
